...
We are not network experts here. This is only provided as a point of general understanding of how the node topology and network interact.
...
<Tabs>
<TabItem value="relay node" label="Relay Node">

```bash title="mainnet-topology.json"
{
  "Producers": [
    {
...
<TabItem value="block producer" label="Block Producer">
