...
:::success
#### Current Official Cardano Node Version: 1.35.5
:::
...
wget -O 1_35_5.zip https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/1_35_5.zip?raw=true
```
