...
:::success
#### Current Official Cardano Node Version: 1.35.3
:::
...
```bash title=">_ Terminal"
unzip cardano-1_35_3-aarch64-ubuntu_2004.zip?raw=true
```
...
```bash title=">_ Terminal"
mv cardano-1_35_3-aarch64-ubuntu_2004/cardano-node cardano-1_35_3-aarch64-ubuntu_2004/cardano-cli ~/.local/bin
```
...
```bash title=">_ Terminal"
mv cardano-1_35_3-aarch64-ubuntu_2004/files/mainnet/* ~/pi-pool/files
```
...
```bash title=">_ Terminal"
mv cardano-1_35_3-aarch64-ubuntu_2004/files/testnet/* ~/pi-pool/files
```
